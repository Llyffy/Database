...
Пока настраивал ее понял что она затормозила намертво, через systemctl ничего не происходило, я решил прибегнуть к pkill, оно тоже не помогло, решил ребутнуть и теперь вм не может запуститься и висит с этой ошибкой, что делать?

![image](https://github.com/Llyffy/Databases/assets/53367937/f8a90708-dbae-4385-b5cf-6b09cbd7e88a)
